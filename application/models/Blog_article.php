...
//     	$query = $this->db->get_where('tb_blog_article', $set_where);
    ...
    public function get_blog_serach($arr_post, $tmp_per_page, $tmp_offset=0)
    {
    	...
    	$set_select["bar_cl_siteid"]    = $arr_post['bar_cl_siteid'];
    	...
    	// 対象クアカウントメンバーの取得
    	$blog_list = $this->_select_blog_list($set_select, $set_select_like, $set_orderby, $tmp_per_page, $tmp_offset);
     ...
     * @return   array()
     */
    public function _select_blog_list($set_select, $set_select_like, $set_orderby, $tmp_per_page, $tmp_offset=0)
    {
    	...
    	$sql .= ' AND `bar_cl_siteid`  = \'' . $set_select["bar_cl_siteid"] . '\'';
