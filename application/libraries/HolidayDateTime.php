...
class HolidayDateTime extends DateTime
{
    ...
    private static $holidays = array(
        ...
        array('fixed',   1,  1, 1949, 9999, '元日'),
        array('fixed',   1, 15, 1949, 1999, '成人の日'),
        array('happy',   1,  2, 2000, 9999, '成人の日'),
        array('fixed',   2, 11, 1967, 9999, '建国記念の日'),
        array('spring',  3,  0, 1949, 9999, '春分の日'),
        array('fixed',   4, 29, 1949, 1989, '天皇誕生日'),
        array('fixed',   4, 29, 1990, 2006, 'みどりの日'),
        array('fixed',   4, 29, 2007, 9999, '昭和の日'),
        array('fixed',   5,  3, 1949, 9999, '憲法記念日'),
        array('fixed',   5,  4, 1988, 2006, '国民の休日'),
        array('fixed',   5,  4, 2007, 9999, 'みどりの日'),
        array('fixed',   5,  5, 1949, 9999, 'こどもの日'),
        array('happy',   7,  3, 2003, 9999, '海の日'),
        array('fixed',   7, 20, 1996, 2002, '海の日'),
        array('fixed',   8, 11, 2016, 9999, '山の日'),
        array('autumn',  9,  0, 1948, 9999, '秋分の日'),
        array('fixed',   9, 15, 1966, 2002, '敬老の日'),
        array('happy',   9,  3, 2003, 9999, '敬老の日'),
        array('fixed',  10, 10, 1966, 1999, '体育の日'),
        array('happy',  10,  2, 2000, 9999, '体育の日'),
        array('fixed',  11,  3, 1948, 9999, '文化の日'),
        array('fixed',  11, 23, 1948, 9999, '勤労感謝の日'),
        array('fixed',  12, 23, 1989, 9999, '天皇誕生日'),
        //以下、1年だけの祝日
        array('fixed',   4, 10, 1959, 1959, '皇太子明仁親王の結婚の儀'),
        array('fixed',   2, 24, 1989, 1989, '昭和天皇の大喪の礼'),
        array('fixed',  11, 12, 1990, 1990, '即位礼正殿の儀'),
        array('fixed',   6,  9, 1993, 1993, '皇太子徳仁親王の結婚の儀'),
    );
