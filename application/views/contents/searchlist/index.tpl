        ...
        <tbody>
            <tr>
                <td>
                    ...
                    {$tnp.tp_shopname} :: {$tnp.tp_shopname_sub}<br>
                    {$tnp.tp_overview}<br><br>
                    〒 {$tnp.tp_zip01}-{$tnp.tp_zip02} {$tnp.tp_prefname}{$tnp.tp_addr01} {$tnp.tp_addr02} {$tnp.tp_buil}<br>
                    連絡先：{$tnp.tp_mail} TEL.{$tnp.tp_tel}<br>
                    アクセス：{$tnp.tp_accessinfo}<br>
