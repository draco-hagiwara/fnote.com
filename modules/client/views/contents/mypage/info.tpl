...
{form_open('/mypage/info/' , 'name="idpwForm" class="form-horizontal"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
      {form_input('cl_id' , set_value('cl_id', $cl_id) , 'class="col-sm-4 form-control" placeholder="ログインID(英数字、アンダースコア("_")、ダッシュ("-") のみ)を入力してください"')}
...
<br><hr><br>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
      {form_input('cl_blog_title' , set_value('cl_blog_title', $cl_blog_title) , 'class="col-sm-4 form-control" placeholder="タイトルを入力してください"')}
