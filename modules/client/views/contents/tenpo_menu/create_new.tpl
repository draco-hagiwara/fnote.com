...
{form_open('/tenpo_menu/create_menu/' , 'name="menuForm" class="form-horizontal"')}
  ...
  <div class="form-group">
    <label for="mn_seq01" class="col-sm-1 control-label">第一 MENU</label>
    ...
    <label for="mn_seq02" class="col-sm-1 control-label">第二 MENU</label>
    <div class="col-sm-3 btn-lg">
  ...
  <br><br><br>
  <div class="form-group">
    <label for="nm_name" class="col-sm-2 control-label">第一 MENU：追加</label>
    <div class="col-sm-4">
      {form_input('mn_name01' , set_value('mn_name01', '') , 'class="form-control" placeholder="追加する第一 MENUを入力してください"')}
  ...
  <div class="form-group">
    <label for="mn_name02" class="col-sm-2 control-label">第二 MENU：追加</label>
    <div class="col-sm-4">
      {form_input('mn_name02' , set_value('mn_name02', '') , 'class="form-control" placeholder="追加する第二 MENUを入力してください"')}
    ...
    <div class="col-sm-6">
      ...
      ※必ず「第一 MENU」を選択してから「登録」ボタンを押してください。
    </div>
  </div>
  <div class="form-group">
    <label for="mn_name03" class="col-sm-2 control-label">タイトル：追加</label>
    <div class="col-sm-4">
      {form_input('mn_name03' , set_value('mn_name03', '') , 'class="form-control" placeholder="追加するタイトルを入力してください"')}
    ...
    <div class="col-sm-6">
      ...
      ※必ず「第一、第二 MENU」を選択してから「登録」ボタンを押してください。
    </div>
  </div>
