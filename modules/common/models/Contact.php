...
class Contact extends CI_Model
{
    ...
    public function insert_contact($setData)
    {
    	...
    	$set_data['lg_detail']    = 'co_cl_siteid = ' . $setData['co_cl_siteid'] . ' / co_contact_mail = ' . $setData['co_contact_mail'];
    ...
    public function update_contact($setData)
    {
    	...
    	$set_data['lg_type']      = 'contact_update';
    	$set_data['lg_func']      = 'update_contact';
    	$set_data['lg_detail']    = 'co_seq = ' . $setData['co_seq'];
    	$this->insert_log($set_data);
