...
<h4>【カテゴリ検索】</h4>
{form_open('/system/categroup_search/' , 'name="searchForm" class="form-horizontal"')}
...
{form_open('/system/categroup_chg/' , 'name="detailForm" class="form-horizontal"')}
...
{form_open('/system/categroup_chg/' , 'name="detailForm" class="form-horizontal"')}
  ...
  <div class="form-group">
    ...
    <p class="col-sm-6">カテゴリの削除を行いたい場合は、システム担当者に問合せしてください。</p>
  </div>
