...
{form_open('entryconf/cl_confirm/' , 'name="EntryconfForm" class="form-horizontal"')}
  <div class="form-group">
    ...
    <div class="col-sm-8">
      {form_input('cl_siteid' , set_value('cl_siteid', $cl_siteid) , 'class="form-control" placeholder="サイトID(URL名)を英数字で入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      {form_input('cl_id' , set_value('cl_id', $cl_id) , 'class="form-control" placeholder="ログインID(英数字、アンダースコア("_")、ダッシュ("-"))を入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      {form_input('cl_company' , set_value('cl_company', $cl_company) , 'class="form-control" placeholder="会社名を入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
      {form_input('cl_president01' , set_value('cl_president01', $cl_president01) , 'class="form-control" placeholder="代表者姓を入力してください"')}
    ...
    <div class="col-sm-4">
      {form_input('cl_president02' , set_value('cl_president02', $cl_president02) , 'class="form-control" placeholder="代表者名を入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      {form_input('cl_department' , set_value('cl_department', $cl_department) , 'class="form-control" placeholder="所属部署を入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
      {form_input('cl_person01' , set_value('cl_person01', $cl_person01) , 'class="form-control" placeholder="担当者姓を入力してください"')}
    ...
    <div class="col-sm-4">
      {form_input('cl_person02' , set_value('cl_person02', $cl_person02) , 'class="form-control" placeholder="担当者名を入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      {form_input('cl_mail' , set_value('cl_mail', $cl_mail) , 'class="col-sm-4 form-control" placeholder="メールアドレスを入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      {form_input('cl_mailsub' , set_value('cl_mailsub', $cl_mailsub) , 'class="col-sm-4 form-control" placeholder="メールアドレスを入力してください"')}
