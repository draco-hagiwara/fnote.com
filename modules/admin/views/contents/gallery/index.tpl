...
{*リスト表示処理 (START)*}
{section name=i start=$pager['index'] loop=$pagelengthAdmin}
	{if (!empty($lines[$smarty.section.i.index])) }
		{$lines_array[$smarty.section.i.index] = explode(",",$lines[$smarty.section.i.index])}
		{$id=$lines_array[$smarty.section.i.index][0]}
		{$lines_array[$smarty.section.i.index][3] = rtrim($lines_array[$smarty.section.i.index][3])}
		{*$lines_array[$smarty.section.i.index][1] = ymd2format($lines_array[$smarty.section.i.index][1])*}{*日付フォーマットの適用*}
		{$alt_text = str_replace('<br />','',$lines_array[$smarty.section.i.index][2])}



ID=={$lines_array[$smarty.section.i.index]}
<br>
日付=={$lines_array[$smarty.section.i.index][1]}
<br>
IMAGE=={$lines_array[$smarty.section.i.index][3]}
<br>

		{if (strpos($lines_array[$smarty.section.i.index][0], 'no_disp') !== false) }
			{$img_id = str_replace('no_disp','',$lines_array[$smarty.section.i.index][0])}
